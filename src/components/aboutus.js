    ...
    <div id="aboutus" className="w-screen  h-auto p-10 sm:p-0 sm:h-[60%] bg-[#F8EDF5] mt-20 flex flex-col sm:flex-row items-center   ">
      <div className="w-full sm:w-[35%] flex flex-col gap-5 p-6 sm:p-20">
        <div className="flex w-full items-start justify-center gap-5 text-[#983D7E]">
          <span className="text-2xl text-left w-full font-bold">
            About us --------------
          </span>
        </div>
        <p className="text-2xl w-full text-left">Lorem ipsum Dummy Text</p>
        <button className="text-white border  bg-[#15206D] w-[40%] sm:w-[30%] px-4 py-2 rounded-lg hover:bg-[#15206D] hover:text-white transition-colors duration-300">
          Read More
        </button>
      </div>
