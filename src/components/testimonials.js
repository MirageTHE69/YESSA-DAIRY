...
function Testimonials() {
  return (
    <div id="testi" className="min-h-[70%] bg-white">
      <div className="flex flex-col justify-center items-center gap-2 pt-10 text-black mt-10">
        <div className="flex justify-center items-center gap-2 text-[#983D7E]">
          <span className="font-extrabold">--------------</span>
          <span className="font-sm text-lg">Testimonial</span>
          <span className="font-extrabold">--------------</span>
        </div>
        <span className="flex justify-center font-bold text-4xl font-Ls">
